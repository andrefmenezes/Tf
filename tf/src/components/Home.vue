  ...
  <div class="container">
        <div class="content first-content">
            <div class="first-column">
                <a  class="title title-primary" href="#"> <img src="../assets/fotos/logo.jpg" ></a> 
                <p class="description description-primary">Já possui conta na TF?</p>
                <p class="description description-primary">faça o login e mantenha-se conctado conosco</p>
                <button id="signin" class="btn btn-primary" v-on:click="teste">sign in</button>
            </div>    
        ...
        <div class="content second-content">
            <div class="first-column">
                <a  class="title title-primary" href="#"> <img src="../assets/fotos/logo.jpg" ></a>                       
                <p class="description description-primary">Ainda não tem conta?</p>
                ...
                <button id="signup" class="btn btn-primary" v-on:click="teste2" >sign up</button>
            </div>
            <div class="second-column">
                ...
                <form class="form">
                    ...
                    <button class="btn btn-second">
                        <router-link to="/portifolio"> sign in </router-link>
                    </button>
                </form>
            </div><!-- second column -->
        </div><!-- second-content -->
